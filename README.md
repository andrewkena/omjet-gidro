...
- **Посмотреть эхограмму** — отдельное окно с водопадом сонара по выбранному файлу
  (столбец — пинг, строка — амплитуда по глубине), раскрашенным той же радужной
  палитрой, что и точки на карте (слабый сигнал — синий, сильный — красный), с
  прокруткой. Каждый столбец растягивается под глубину дна этого пинга (сглаживает
  скачки от автодиапазона сонара). Слева — линейка глубин (закреплена у края окна,
  не уезжает при горизонтальной прокрутке), снизу — ось времени/расстояния
  (берётся из настройки «Временная шкала»). Колесо мыши над изображением или
  линейкой — масштаб (0.1×–20×), ползунок «Контраст» — усиление контраста
  амплитуды. Формат этих байт нигде не задокументирован и не проверен на реальном
  железе — реализовано по общепринятому для .sl2 предположению (см.
